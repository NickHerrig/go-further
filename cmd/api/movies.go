...
func (app *application) createMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = app.storage.Movies.Insert(movie)
	if err != nil {
...
func (app *application) showMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	movie, err := app.storage.Movies.Get(id)
	if err != nil {
		switch {
...
func (app *application) updateMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = app.storage.Movies.Update(movie)
	if err != nil {
		switch {
...
func (app *application) deleteMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	msg := envelope{"message": "movie successfully deleted"}
...
func (app *application) listMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	movies, metadata, err := app.storage.Movies.GetAll(input.Title, input.Genres, input.Filters)
	if err != nil {
		app.serverErrorResponse(w, r, err)
		return
	}
