...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://greenlight:mysecretpassword@localhost/greenlight?sslmode=disable", "PostgreSQL DSN")
...
func openDB(cfg config) (*pgxpool.Pool, error) {
	...
	db, err := pgxpool.Connect(ctx, cfg.db.dsn)
	if err != nil {
		return nil, err
	}
